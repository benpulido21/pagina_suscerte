		...
		<div class="adt_grids">
			<div class="col-md-5 about_left wow flipInY" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="col-sm-6 bottom-gds ">
					<div class="bott-img">
					<a href="{{asset('images/16.jpg')}}" class="swipebox"><img src="{{asset('images/16.jpg')}}" width="220" height="220"></a>
				...
				<div class="col-sm-6 bottom-gds ">
					<div class="bott-img">
					<a href="{{asset('images/17.jpg')}}" class="swipebox"><img src="{{asset('images/17.jpg')}}" width="220" height="220"></a>
						<!--<div class="icon-holder">
	...
	<div class="container">
		...
		<div class="adt_grids">
			<div class="col-md-5 about_left wow flipInY" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="col-sm-6 bottom-gds ">
					<div class="bott-img">
					<a href="{{asset('images/18.jpg')}}" class="swipebox"><img src="{{asset('images/18.jpg')}}" width="220" height="220"></a>
						<!--<div class="icon-holder">
							<span class="glyphicon glyphicon-education icon" aria-hidden="true"></span>
						</div>
						<h4 class="mission">Design</h4>
	...
	<div class="container">
		...
		<div class="adt_grids">
			<div class="col-md-5 about_left wow flipInY" data-wow-duration="1.5s" data-wow-delay="0s">
				<div class="col-sm-6 bottom-gds ">
					<div class="bott-img">
					<a href="{{asset('images/111.jpg')}}" class="swipebox"><img src="{{asset('images/111.jpg')}}" width="220" height="220"></a>
						<!--div class="icon-holder">
							<span class="glyphicon glyphicon-education icon" aria-hidden="true"></span>
						</div>
						<h4 class="mission">Design</h4>
